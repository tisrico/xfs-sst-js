...
/* Values for WFSPINCAPS.dwRSAAuthenticationScheme and the fast-track Capabilities lpszExtra parameter, REMOTE_KEY_SCHEME. */
...
/* GRGB extension/
/*=================================================================*/
#define WFS_CMD_PIN_GET_PASSWORD 		(PIN_SERVICE_OFFSET + 95)    

#define WFS_PIN_OPERATOR_1			(1)
#define WFS_PIN_OPERATOR_2			(2)

#define WFS_PIN_ENTER_PASSWORD 		(1)
#define WFS_PIN_ENTER_NEW_PASSWORD 	(2)
#define WFS_PIN_REPEAT_NEW_PASSWORD (3)
...
typedef struct _wfs_pin_get_password_out
{
	WORD wCompletion;
	BOOL bResult;
} WFSPINGETPASSWORDOUT, *LPWFSPINGETPASSWORDOUT;
